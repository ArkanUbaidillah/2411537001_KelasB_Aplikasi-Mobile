// TUGAS: Pengenalan Widgets.
// Tugas 1: warna kartu saldo jadi teal. Tugas 2: teks No. Rekening.
...
class _BalanceCardWidgetState extends State<BalanceCardWidget> {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      // TUGAS 1: warna kartu diubah dari blueAccent menjadi teal
      color: Colors.teal,
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // TUGAS 2: teks statis nomor rekening di bawah nominal saldo
            const SizedBox(height: 8),
            const Text(
